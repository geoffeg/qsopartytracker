...
const index = (config, stateCorners) => {
    // const qsoPartyAbbv = config.stateAbbr;
...
<body>
    ...
    <main>
        <div id="map"></div>
        <div id="tableContainer" hx-trigger="load, every 30s" hx-get="/${config.stateAbbr}/stations.html"></div>
    </main>
    <footer>
